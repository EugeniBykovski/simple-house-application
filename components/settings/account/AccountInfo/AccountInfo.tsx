...
import { AccountInfoProps, languages } from "./types";
...
export const AccountInfo = ({
  ...
  const { mutate: editProfile, isPending } = useMutation({
    ...
    onSuccess: async (res: AccountInfoSettingsSchema) => {
      if (res.language !== lang) onSelectChange(res.language as "ru" | "en");
      await update();
      router.refresh();
    },
  ...
  return (
    <Card className="bg-background py-4 border-dashed shadow-none">
